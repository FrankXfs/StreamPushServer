package com.stream.pushserver.service;
...
import static com.stream.pushserver.util.PropertiesUtil.load;
...
//	public static FFmpegConfig config=(FFmpegConfig) load(System.getProperty("user.dir")+"\\src\\main\\java\\loadFFmpeg.properties",  FFmpegConfig.class);
	//public static FFmpegConfig config=(FFmpegConfig) load("/Users/frank/Documents/workspace/ffmpegCommandManage/src/ffmpegCommandManage/config/loadFFmpeg.properties",  FFmpegConfig.class);
	/**
	 * 注入自己实现的持久层
	 * 
	 * @param taskDao
